...
export default function NavBar() {
    ...
    const ItemsNav = [
        {
            id: 1,
            text: translate('nav_item_text_1'),
            more: translate('nav_item_more_1')
        },
        {
            id: 2,
            text: translate('nav_item_text_2'),
            more: translate('nav_item_more_2')
        },
        {
            id: 3,
            text: translate('nav_item_text_3'),
            more: translate('nav_item_more_3')
        },
        {
            id: 4,
            text: translate('nav_item_text_4'),
            more: translate('nav_item_more_4')
        },
        {
            id: 5,
            text: translate('nav_item_text_5'),
            more: translate('nav_item_more_5')
        },
        {
            id: 6,
            text: translate('nav_item_text_6'),
            more: translate('nav_item_more_6')
        },
        {
            id: 7,
            text: translate('nav_item_text_7'),
            more: translate('nav_item_more_7')
        }
    ]
    ...
    return (
        <div className="w-full font-inter relative shadow-header-shadow">
            <div>
                {visible && (
                ...
                <div className="relative screen-1600:px-custom-88 screen-1400:px-5 screen-1200:px-3 screen-992:py-0 screen-576:px-5 py-custom-15 px-0 w-full leading-custom-21 border-b-[0.25px] border-[#dbdee9] shadow-nav-shadow bg-white z-1000">
                    <div className="w-full px-3 flex items-center justify-between">
                        <div>
                            <div className="w-full flex flex-row items-center justify-center h-[31px]">
                                ...
                                <p className="font-[700] text-2xl text-[#b34cef] mt-1 font-gotham">InsAI</p>
                            </div>
                        </div>
